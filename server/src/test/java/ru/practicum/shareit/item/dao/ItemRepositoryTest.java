...
class ItemRepositoryTest {
    ...
    @Test
    void shouldFindAllItemsByOwnerId() {
        //do
        List<Item> items = itemRepository.findAllItemsByOwnerId(user1.getId());

        //check
        assertNotNull(items.getLast().getId());
        assertThat(items.getLast().getId()).isEqualTo(item.getId());
        assertThat(items.getLast().getName()).isEqualTo(item.getName());
    }

    @Test
    void shouldFindAllItemsByRequestIdIn() {
        //prepare
    ...
    @Test
    void shouldFindAllItemsByRequestId() {
        //do
        List<Item> items = itemRepository.findAllItemsByRequestId(itemRequest.getId());
